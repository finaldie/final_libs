...
void test_mbuf()
{
...

    {
        ...
        int total_free = fmbuf_total_free(pbuf);
    ...
    fmbuf_head_seek(pbuf, 10);
    fmbuf_tail_seek(pbuf, 20);
...
void test_mbuf1()
{
    ...
    // push 8 byte data
    {
        int ret = fmbuf_push(pbuf, push_buf, 8);
        FTU_ASSERT_EQUAL_INT(0, ret);
    ...
    // clear and seek mbuf and push 5 bytes
    {
        ...
        fmbuf_head_seek(pbuf, 4);
        fmbuf_tail_seek(pbuf, 6);
    ...
    {
        int ret = fmbuf_push(pbuf, push_buf, 2);
        FTU_ASSERT_EQUAL_INT(0, ret);
    ...
    // pop 6 bytes
    {
        int ret = fmbuf_pop(pbuf, pop_buf, 6);
        FTU_ASSERT_EQUAL_INT(0, ret);
    ...
    {
        fmbuf_clear(pbuf);
        fmbuf_head_seek(pbuf, 6);
        fmbuf_tail_seek(pbuf, 4);

        fmbuf_head_move(pbuf, 5);
